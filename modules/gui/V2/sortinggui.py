...
class sortingGui(QWidget, Ui_sortingGui):
    def __init__(self, *args, **kwargs):
        ...
        self.lensTypeUsed = LenseType.NEW_LENS
    ...
    def detect_objects(self, camera_image, store_features=False):
        ...
        if self.ui.radio_classic.isChecked():
            preprocessed_image = image_preprocessing(image,self.lensTypeUsed)
            contours, rectangles, bounding_boxes, object_images = get_objects_in_preprocessed_image(preprocessed_image, smaller_image_area=True)
