...
def calc_transformation_matrices():
    ...
    # Random Center Left: 263, 141 --> (-20, -60, -58, 0, 0, 0)
    # Random Center Right: 691, 231 --> (20, 120)
    # Random Point Left: 168, 334 --> (60, -100)
    ...
    cam_points = np.array([[263, 141], [691, 231], [168, 334]]).astype(np.float32)
